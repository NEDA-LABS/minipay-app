  ...
  return (
    <footer className="bg-slate-50 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700">
      <div className="container mx-auto max-w-3xl px-4 flex flex-col items-center justify-center text-center">
        ...
        {/* Tagline */}
        <div className="text-sm text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mt-2">
          Empowering merchants to accept stablecoin payments easily and
      ...
      {/* Copyright */}
      <div className="mt-4">
        {/* <hr className="my-8 border-blue-100/50 dark:border-blue-900/50" /> */}

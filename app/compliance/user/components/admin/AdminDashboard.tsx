          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{stats.pendingKYB}</p>
              </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        {verification.firstName || verification.businessName}
                        {verification.lastName ? ` ${verification.lastName}` : ''}
                      </h4>
                      <p className="text-sm text-gray-600">{verification.email}</p>
                      <p className="text-xs text-gray-500">
                        Submitted: {formatDate(verification.submittedAt || verification.createdAt)}
                      </p>
                    </div>
                  </div>

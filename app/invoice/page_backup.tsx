...
import { Loader2, TrendingUp, DollarSign, FileText, BarChart3 } from "lucide-react";
          ...
          <CardContent className="relative p-6">
            <Tabs defaultValue="history" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-slate-800/50 rounded-xl">
                ...
                <TabsTrigger value="stats" className="data-[state=active]:bg-slate-700 data-[state=active]:text-white">

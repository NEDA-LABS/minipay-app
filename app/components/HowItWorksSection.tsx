...
export default function HowItWorksSection() {
  ...
  return (
    <div id="how-it-works" className="relative" style={{
      backgroundImage: 'linear-gradient(to bottom, transparent 0%, rgba(0, 74, 109, 0.5) 25%, rgba(0, 74, 109, 0.5) 80%, transparent 100%)'
    }}>
      {/* Decorative Elements */}
              ...
              <div key={index} className="relative group h-full">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br ${step.gradient} flex items-center justify-center shadow-md hover:scale-105 transition-transform duration-300`}
                    >

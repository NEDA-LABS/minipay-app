        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20">
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <button className="p-2 text-purple-600 hover:text-purple-800 hover:bg-purple-50 rounded-lg transition-colors duration-200">
          ...
          {invoices.length > 0 && (
            <div className="flex items-center justify-between mt-6">
              <button className="px-4 py-2 !bg-gray-100 !text-gray-400 !rounded-xl cursor-not-allowed" disabled>
                Previous
              </button>
              <span className="text-sm text-gray-600 font-medium">Page 1 of 1</span>
              <button className="px-4 py-2 !bg-gray-100 !text-gray-400 !rounded-xl cursor-not-allowed" disabled>
                Next
              </button>
            </div>
